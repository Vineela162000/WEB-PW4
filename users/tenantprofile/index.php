			...
			<div class="collapse navbar-collapse" id="nav-bar-links">
				<?php
					...
					if ($_SESSION['login_USERTYPE'] == 'tenant')
						print'
									<li><a href="">Tenants Profile</a></li>
									<li><a href="../tenantsearch">Search for Properties</a></li>
									<li class="divider"></li> 
						';
					...
					<div class="col-md-7">
						...
						<p style="margin-top:3px">
							<?php 
								...
								else print '<span style="color:#04B45F">A profile has been created or it already exists.</span><br>';
							?>
							After your profile has been set, the owners will be able to contact you.
						</p>
						<form class="form-horizontal" method="post" onSubmit="return validateprofile()" action="">
	                        <div name="form-validate" class="form-group">
	                        	...
	                        	<div class="col-md-6">
	                        		<input type="number" class="form-control" id="AGE" name="AGE" placeholder="Wnter your age." min="18" max="99" value="<?php print $AGE;?>">
	                        	</div>
	                        </div>
							<div name="form-validate" class="form-group">
	                        ...
	                        <div name="form-validate" class="form-group">
	                     	...
	                     	<div name="form-validate" class="form-group">
	                        	<label for="PET_OWNAGE" class="col-md-3 control-label">Do you own a pet?:</label>
	                        ...
	                        <div class="form-group">
		                        <div class="col-md-9 col-md-offset-3">
			                        <button type="submit" class="btn btn-default" name="submit1">Set up or Update Profile</button>
						...
						<h3>Delete Account</h3>
							...
							<div class="collapse" id="collapseExample">
								<div class="well" style="padding:10px; width:70%">
									...
									<p>All the information will be lost. Confirm to delete.</p>
