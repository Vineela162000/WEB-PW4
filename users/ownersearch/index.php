<?php
	...
	if(isset($_POST['delpref'])){
		if($OWNERPREF_EXISTS){
			mysqli_query($conn, "DELETE FROM ownersearch WHERE '$ID'");
			$OWNERPREF_EXISTS = false;
		}
	}
	...
	if(isset($_POST['matchbtn'])){
		savePreferences();
		$result = mysqli_query($conn, "SELECT * FROM tenantprofiles");
		$num_rows = mysqli_num_rows($result);
		$row = mysqli_fetch_assoc($result);
		$TenantArr = array();
	...
	function savePreferences(){
		global $MIN_AGE, $MAX_AGE, $OCCUPATION, $INCOME, $PET, $SMOKES, $conn, $OWNERPREF_EXISTS, $ID;
...
<body>
			...
			<div class="collapse navbar-collapse" id="nav-bar-links">
				<?php
					...
					if ($_SESSION['login_USERTYPE'] == 'owner')
						print'
									<li><a href="../ownerpost">Your Listings</a></li>
									<li><a href="../ownerpost/newpost">Post an Advertisments</a></li>
									<li><a href="">Search for Tenants</a></li>
	...
	<div class="container">
		<div class="well">
			<div class="row">
				<div class="col-md-12">
					<h3 style="display: block">Search Properties
					...
					<div id="SEARCH_SETTINGS" class="collapse in" style="margin-top:10px">
						<form  onSubmit="return validateSearch()" method="post" action="">
							...
							<div class="row">
		                        <div name="form-validate" class="form-group">
		                        	<label for="INCOME" class="col-md-2 control-label">Salary Per Annum</label>
		                        	<div class="col-md-4">
	                        ...
	                        <div class="row">
		                     	<div name="form-validate" class="form-group">
		                        	<label for="PET_OWNAGE" class="col-md-2 control-label">Do you have a pet?</label>
	                        ...
	                        <div class="row">
		                        <div name="form-validate" class="form-group">
		                        	<label for="SMOKER" class="col-md-2 control-label">Do you smoke?</label>
						...
						if (isset($_POST['matchbtn'])) {
							...
							if ($TenantArr != null && count($TenantArr) != 0) {
								foreach ($TenantArr as $TA) { 
									...
									$row = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM tenantprofiles WHERE MemberID = '$TenantID'"));
									$PRIMEKEY = $row['MemberID'];
									$row2 = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM user WHERE MemberID = '$PRIMEKEY'"));
									print'
										<div class="row">
