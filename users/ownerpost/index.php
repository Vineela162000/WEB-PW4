...
<head>
	...
	<title>Owner Postings - Property Shark</title>
				...
				<?php
					...
					if ($_SESSION['login_USERTYPE'] == 'owner')
						print'
									...
									<li><a href="newpost/">Post an Advertisement</a></li>
									<li><a href="../ownersearch">Search for Tenants</a></li>
					...
					if ($_SESSION['login_USERTYPE'] == 'tenant')
						print'
									...
									<li><a href="../tenantsearch">Search Properties</a></li>
									<li class="divider"></li> 
						';
		...
		<div class="well">
				<div class="row">
					<div class="col-xs-8 col-sm-9">
						<h3 style="margin-top: 5px"><?php print $num_rows; ?> Listings</h3>
					</div>
					<div class="col-xs-4 col-sm-3">
						<a class="btn btn-info" style="float:right" href="newpost/">Add a Property Listing</a>
					</div>
				</div>
				<hr>
				<?php
						...
						print'
							<div class="row">
								...
								<div class="col-sm-9 col-lg-10">
									...
									<form method="post" action=""><button type="submit" class="btn btn-danger btn-sm" name="DELETEPOST" value="'.$row['PostID'].'">Delete Listing</button></form>
								</div>
							</div>
							<hr>
						';
