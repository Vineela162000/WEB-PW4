...
<head>
	...
	<title>Account Settings - Property Shark</title>
				...
				<?php
					...
					if ($_SESSION['login_USERTYPE'] == 'owner')
						print'
									...
									<li><a href="../ownerpost/newpost">Post an Advertisement</a></li>
		...
		<div class="well">
				<div class="row">
					<div class="col-md-12">
						...
						?>
						<h3> You can change your contact information here</h3>
						<form method="post" onSubmit="return validateChange()">
						    ...
						    <button type="submit" class="btn btn-primary" name="submit2">Click here to change contact information</button>
						</form>
					</div>
				</div>
				<div class="row">
						...
						<h3>Delete Account</h3>
							...
							<div class="collapse" id="collapseExample">
								<div class="well" style="padding:10px">
									...
									<p>All the information will be deleted once you confirm</p>
